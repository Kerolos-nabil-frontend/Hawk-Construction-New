...
//     contractor:"Aljaidaa International General Trading and Contracting Company.",
//   },
//    {
...
//     video: SchoolVideo,
//     category: "Educational",
//     area: "Khaitan, Farwaniya Governorate.",
...
//     contractor:
//       "Al-Ghanim International Contracting Co. & Ahmadiah Contracting Trading Company.",
//   },
//   {
...
//     scope:
//       "Cement Plaster, Fair Face, Sigma& Internal Point.",
//     contractor: "Back Combined General Trading & Contracting Company.",
//   },
...
//     contractor: "M.A.Al Kharafi & Sons Company.",
//   },
...
//     scope: "Fair Face, Cement Plaster, Painting & Exterior texture.",
//     contractor: "G. A. K ACICO Construction Company.",
//   },
//   {
...
//     contractor: "M.A. Kharafi & Sons Company.",
//   },
//   {
...
import Omoma from "../../assets/images/Omoma.jpg";
import Aca from "../../assets/images/Aca.jpg";
import Palms1 from "../../assets/images/Palms1.jpg";
import Palms2 from "../../assets/images/Palms2.jpg";
import Palms3 from "../../assets/images/Palms3.avif";
...
const allProjects = [
  ...
  {
    title: "KFC Restaurants.",
    images: [Kfc],
    category: "Commercial",
    area: "Multiple Locations.",
    scope: "Gypsum Board.",
    contractor: "Americana Food Co.",
  },
  {
    title: "Al Salam Hospital Worker's Residence - 10 Floors.",
    images: [Salam],
  ...
  {
    title: "Ministry of Education ( South Surra Area - Ministries Zone ).",
    images: [Place],
    category: "Governmental",
    area: "Al-Qibla, Kuwait.",
    scope: "Fair Face, Cement Plaster & Selfleveling screed.",
    contractor: "M.A.Al Kharafi & Sons Co.",
  },
  {
    title: "Wataniya Resort (84 Chalets)(Khairan Area).",
    images: [Place],
    category: "Hotels",
    area: "Khairan Area, Kuwait.",
    scope: "Fair Face, Cement, Painting, Plaster & Exteriortexture.",
    contractor: "G.A.K ACICO Construction Co.",
  },
  {
    title: "Chevron Villas AlZuar(20 villas) (Al Zuar Area).",
    images: [Place],
    category: "Governmental",
    area: " Bayan area of the Hawalli Governorate.",
    scope: "Cement Plaster, Painting, Fair Face & Cement Tiling.",
    contractor: "M.A.Al Kharafi & Sons Co.",
  },
  {
    title: "Ambassador's palace of Kingdom of Saudi Arabia.",
    images: [Place],
    category: "Governmental",
    area: " Embassy Zone, Al Shaab.",
    scope: "Block Work, Fair face, Painting & Exterior texture.",
    contractor: "China State Construction Engineering Corporation Middle East",
  },
  {
    title: "KISR New Headquarter at Shewik Campus.",
    images: [Place],
    category: "Governmental",
    area: "  Al Shuwaikh Educational area in Kuwait.",
    scope: "Gypsum Board.",
    contractor: "Al Enma'a Company.",
  },
  {
    title: "J3 Residential and Mall Project in Jaber AlAhmad",
    images: [Place],
    category: "Residential Buildings",
    area: " Jaber Al Ahmad City.",
    scope: "External Plaster, Exterior Texture, Ceramic Tiling, GB Ceiling & Internal Painting.",
    contractor: "Alghanim International general Trading & Contracting Co.",
  },
  {
    title: "Kuwait Institute for Scientific Research.",
    images: [Place],
    category: "Governmental",
    area: " Al Jahez Street, Al Shuwaikh Educational area.",
    scope: "Cement Plaster, Fair Face & Painting.",
    contractor: "Al Enma'a Company.",
  },
  {
    title: "Car Park of Kuwait Institute for Judicial & Legal Studies.",
    images: [Place],
    category: "Governmental",
    area: "Fahd Al Salem St.",
    scope: "Concrete Forming, Steel Reinforcement, Block Work, Fair Face, Cement Plaster, Painting, Exterior texture, Ceramic Tiling, Gypsum Ceiling (Board Tile) Terrazzo Tile & Marble Stone.",
    contractor: "AlTawbad General Trading & Contracting Co.",
  },
  {
    title: "Guest Palace Bayan Al Amiri Palace.",
    images: [Place],
    category: "Governmental",
    area: " Mina Saud area of Kuwait.",
    scope: "Fair Face, Cement Plaster, Painting & Exterior Texture.",
    contractor: "G.A.K Acico Construction.",
  },
  {
    title: "The Palms Beach Hotel & Spa.",
    images: [Palms1, Palms2, Palms3],
    category: "Hotels",
    area: "Al Bida'a (Al Bedaa) district of Salwa, along the beachfront of the Arabian Gulf Road in Kuwait.",
    scope: "Cement Plaster, Painting & Exterior Texture.",
    contractor: "G.A.K Acico Construction.",
  },
  {
    title: "American University inMiddle East. (Al Egilia ) Repair for parking Elevation.",
    images: [Aca],
    category: "Educational",
    area: "  Egaila, Kuwait.",
    scope: "Remove old Texture, Cement Plaster, ExteriorTexture & Painting.",
    contractor: "Arabian Company for Educational Services.",
  },
  {
    title: "New Head Quarter of Central Bank of Kuwait.",
    images: [Place],
    category: "Governmental",
    area: " Al- Sharq, Al'Asimah, 25 Rd.",
    scope: "Concrete forming, Steel Reinforcement, Fair Face,Concrete shipping, Block work, Cement Plaster, Ceramic Tiling & Structural Topping.",
    contractor: "M.A.Al Kharafi & Sons Co. W.L.L.",
  },
  {
    title: "Embassy Building Project.",
  ...
  {
    title: "El Noqra Tower.",
    images: [Place],
    category: "Commercial",
    area: "Hawally district of Kuwait.",
    scope: "EIFS System.",
    contractor: "First United Building Construction Co. W.L.L. (FUBC).",
  },
  {
    title: "Jahra Court Complex.",
    images: [Court],
  ...
  {
    title: "Al Jaber Al Ahmed Showroom (Al Ahmadi Area).",
    images: [Place],
    category: "Governmental",
    area: "North Al-Ahmadi Area.",
    scope: "Concrete repair, Painting & Marble Stone.",
    contractor: "M.A.Al Kharafi & Sons Co.",
  },
  {
    title: "Villa Mr. Saleh Ahmed Al Sarhaan.",
  ...
  {
    title: "Palliative Care Center Hospital.",
    images: [Place2],
    category: "Healthcare",
    area: " Sabah Health Area, Shuwaikh.",
    scope: "Gypsum Board & Cement Plaster.",
    contractor: "First Group Company.",
  },
  {
    title: "ALRabia Secondary School for girls Renovation.",
    images: [Place2],
    category: "Educational",
    area: "Al Rabia area within the Farwaniyah Governorate.",
    scope: "Fair Face, Painting & Exterior Rendering.",
    contractor: "Al Alamia Company.",
  },
  {
    title: "Al Omooma Hospital.",
    images: [Omoma],
    category: "Healthcare",
    area: " Fourth Right Rd, Al Farwaniyah.",
    scope: "Gypsum Board, Cement Plaster & painting.",
    contractor: "First Group Company.",
  },
  {
    title: "MR. Basim Alotaibi Villa.",
    images: [Place],
    category: "Villas",
    area: " Fourth Right Rd, Al Farwaniyah.",
    scope: "EIFS System.",
  ...
  {
    title: "Private Tower at Salmiya Area Gulf Road.",
    images: [Place],
    category: "Villas",
    area: " Salmiya Area.",
    scope: "Gypsum Board works.",
    contractor: "First Group Company.",
  },
  {
    title: "Al Sheik Salman Chalet.",
    images: [Place],
    category: "Villas",
    area: " Al Galaa Area.",
    scope: "Exterior Landscaping Including forming, CastingFinishes Swimming pool & Exterior Rendering.",
    contractor: "Owner.",
  },
  {
    title: "Mr. Hani Al Jassim Villa.",
    images: [Place],
    category: "Villas",
    area: " Sadieeq area.",
    scope: "Concrete forming, Steel Reinforcement, Fair Face, Block Face, Cement Plaster, Painting, ExteriorTexture, Ceramic Tiling, Gypsum Ceiling (BoardTile) , Terrazzo Tiling, & Marble stone.",
    contractor: "Owner.",
  },
  {
    title: "Al Salam HospitalWorker's Residence 10 Floors.", 
    images: [Place2],
    category: "Healthcare",
    area: " Port Said Street, Bneid AL Gar, Safat - Dasma",
    scope: "Fair Face, Cement Plaster, Painting & Exterior Texture.",
    contractor: "Tasneim Company for General Trading &Contracting.",
  },
];
    ...
    <div className="bg-gray-50">
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          {proj.isMultiPhase ? (
            <div className="relative bg-gradient-to-br from-blue-600 to-blue-800 h-72 flex flex-col items-center justify-center p-6 text-white">
              <div className="absolute top-4 right-4 bg-yellow-400 text-blue-900 px-3 py-1 rounded-full text-xs font-bold">
                Multi-Phase Project
              </div>
              <div className="text-center">
                <div className="text-6xl font-bold mb-2">{proj.phases.length}</div>
                <div className="text-xl font-semibold">Phases</div>
                <div className="text-sm opacity-90 mt-2">
                  {proj.phases[0].year} - {proj.phases[proj.phases.length - 1].year}
                </div>
              </div>
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent group-hover:from-blue-900/60 transition flex items-end justify-center opacity-0 group-hover:opacity-100 rounded-t-3xl">
                <span className="bg-white text-blue-700 px-4 py-2 mb-6 rounded-lg text-base font-semibold shadow-lg animate-bounce">
                  View All Phases
                </span>
              </div>
            ...
            {proj.isMultiPhase && (
              <div className="bg-blue-50 border-l-4 border-blue-500 px-3 py-2 mb-2">
                <p className="text-sm text-blue-800 font-semibold">
                  Multiple contractors and packages across {proj.phases.length} phases
                </p>
              </div>
            )}
            <p className="text-gray-700 text-base font-medium">
  ...
  {selectedProject && (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 px-4">
      ...
      >
        ...
        {/* Media Swiper or Multi-Phase Display */}
        {selectedProject.isMultiPhase ? (
          <div className="rounded-2xl overflow-hidden mb-6 bg-gradient-to-br from-blue-50 to-gray-50 p-8">
            <h3 className="text-2xl font-bold mb-6 text-blue-800 text-center">Project Phases & Packages</h3>
            <Swiper
              modules={[Pagination, Navigation]}
              pagination={{ clickable: true }}
              navigation
                ...
                <SwiperSlide key={i}>
                  <div className="bg-white rounded-xl shadow-lg p-8 min-h-[400px] flex flex-col justify-center">
                    <div className="text-center mb-6">
                      <span className="inline-block bg-blue-600 text-white px-6 py-2 rounded-full text-lg font-semibold">
                        Phase {i + 1}
                      </span>
                    </div>
                    <div className="space-y-4">
                      <div className="border-l-4 border-blue-500 pl-4">
                        <p className="text-sm text-gray-500 font-semibold uppercase">Year</p>
                        <p className="text-xl font-bold text-gray-800">{phase.year}</p>
                      </div>
                      <div className="border-l-4 border-green-500 pl-4">
                        <p className="text-sm text-gray-500 font-semibold uppercase">Area/Package</p>
                        <p className="text-xl font-bold text-gray-800">{phase.area}</p>
                      </div>
