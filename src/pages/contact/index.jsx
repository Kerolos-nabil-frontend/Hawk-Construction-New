            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              {["name", "email", "subject"].map((field) => (
                <div key={field}>
                  ...
                  <input
                    ...
                    className={`mt-1 block w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors[field] ? "border-red-500" : "border-gray-300"
                      }`}
                  />
                  {errors[field] && (
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={5}
                  className={`mt-1 block w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${errors.message ? "border-red-500" : "border-gray-300"
                    }`}
                />
                {errors.message && (
