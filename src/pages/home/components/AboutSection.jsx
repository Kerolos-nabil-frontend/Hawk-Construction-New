...
export default function About() {
  return (
    <section className="relative bg-background text-text font-[Britannic Bold Regular] overflow-hidden pt-20 pb-32 px-6 lg:px-16">

      <div className="absolute top-0 right-0 w-64 h-64 bg-primary/10 rounded-full mix-blend-multiply opacity-70"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary/20 rounded-full mix-blend-multiply opacity-50"></div>
